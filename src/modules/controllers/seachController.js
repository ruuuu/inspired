...
export const seachController = (form) => {
    ...
    form.addEventListener('submit', (evt) => {
        evt.preventDefault();               // чтобы после отправки страница не перезагружалась
        ...
        router.navigate(`search?value=${form.search.value}`);           // перейдем на станицу с урлом  http://localhost:3000/search?value='купальник'
    });
